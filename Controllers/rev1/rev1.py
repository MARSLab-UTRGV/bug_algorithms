...
if __name__ == "__main__":
    ...
    while robot.step(TIME_STEP) != -1:
        ...
        # follows perimeter of obstacle.
            ...
            # print(prev)
            left_wall = left_ir_values[0] > 80 or left_ir_values[1] > 80
            front_wall = ((front_ir_values[0] + front_ir_values[1]) / 2) > 80
            right_wall = right_ir_values[1] > 80 or right_ir_values[0] > 80
            ...
            # following wall on the right with exclusive or (XOR)
